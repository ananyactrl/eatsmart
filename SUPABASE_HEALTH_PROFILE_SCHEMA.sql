-- ====================================================================
-- COMPREHENSIVE HEALTH PROFILE SYSTEM FOR EATSMART
-- Enables personalized meal recommendations based on body, health, and life context
-- ====================================================================
...
CREATE TABLE IF NOT EXISTS user_profiles (
  ...
  health_conditions TEXT[] DEFAULT '{}', -- ['diabetes', 'pcos', 'hypertension', etc.]
  allergies TEXT[] DEFAULT '{}', -- ['dairy', 'nuts', 'shellfish', etc.]
  dietary_restrictions TEXT[] DEFAULT '{}', -- ['low_sodium', 'gluten_free', etc.]
  medications TEXT[] DEFAULT '{}', -- Medications that affect nutrition

  -- LAYER 3: Life Context (practical constraints)
  dietary_type dietary_type NOT NULL DEFAULT 'omnivore',
  cuisine_preferences TEXT[] DEFAULT '{}', -- ['south_indian', 'north_indian', 'italian', etc.]
  ...
  kitchen_equipment TEXT[] DEFAULT '{}', -- ['oven', 'pressure_cooker', 'air_fryer', etc.]
...
CREATE TABLE IF NOT EXISTS health_condition_guidelines (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  condition_name TEXT UNIQUE NOT NULL,
  description TEXT NOT NULL,
  avoid_ingredients TEXT[] DEFAULT '{}', -- Ingredients to flag as concerning
  recommended_nutrients TEXT[] DEFAULT '{}', -- Nutrients to emphasize
  restrict_nutrients TEXT[] DEFAULT '{}', -- Nutrients to limit
...
('diabetes', 'Blood sugar management',
 ARRAY['refined_sugar', 'high_gi_carbs', 'processed_foods'],
 ARRAY['fiber', 'protein', 'complex_carbs'],
 ARRAY['simple_sugars', 'saturated_fat'],
 'Eat smaller, frequent meals. Avoid large carb loads.'),

('pcos', 'Polycystic Ovary Syndrome',
 ARRAY['refined_sugar', 'processed_foods', 'trans_fats'],
 ARRAY['fiber', 'protein', 'omega_3', 'chromium'],
 ARRAY['simple_sugars', 'refined_carbs'],
 'Focus on low-GI foods. Consider intermittent fasting.'),

('hypertension', 'High blood pressure',
 ARRAY['high_sodium', 'processed_meats', 'canned_foods'],
 ARRAY['potassium', 'magnesium', 'fiber'],
 ARRAY['sodium', 'saturated_fat'],
 'Limit sodium to <2300mg daily. Emphasize DASH diet principles.'),

('hypothyroid', 'Underactive thyroid',
 ARRAY['soy', 'cruciferous_raw', 'excessive_fiber'],
 ARRAY['iodine', 'selenium', 'zinc'],
 ARRAY[],
 'Take medications on empty stomach. Wait 4h after eating.'),

('ibs', 'Irritable Bowel Syndrome',
 ARRAY['high_fodmap', 'spicy_foods', 'caffeine'],
 ARRAY['soluble_fiber', 'probiotics'],
 ARRAY['insoluble_fiber', 'high_fat'],
 'Follow low-FODMAP diet. Keep food diary.'),

('ckd', 'Chronic Kidney Disease',
 ARRAY['high_phosphorus', 'high_potassium', 'processed_meats'],
 ARRAY[],
 ARRAY['protein', 'sodium', 'phosphorus', 'potassium'],
 'Protein restriction based on stage. Monitor mineral intake.'),

('gerd', 'Gastroesophageal Reflux Disease',
 ARRAY['citrus', 'tomatoes', 'spicy_foods', 'caffeine', 'chocolate'],
 ARRAY[],
 ARRAY['high_fat'],
 'Avoid eating 3h before bed. Smaller, frequent meals.'),

('celiac', 'Celiac Disease',
 ARRAY['gluten', 'wheat', 'barley', 'rye'],
 ARRAY['fiber', 'b_vitamins', 'iron'],
 ARRAY[],
 'Strict gluten avoidance. Check for cross-contamination.');

-- Common allergies and their ingredient patterns
CREATE TABLE IF NOT EXISTS allergy_ingredients (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  allergy_name TEXT NOT NULL,
  avoid_ingredients TEXT[] NOT NULL,
  hidden_sources TEXT[] DEFAULT '{}', -- Where allergen might be hidden
...
('dairy',
 ARRAY['milk', 'cheese', 'butter', 'yogurt', 'cream', 'whey', 'casein', 'lactose'],
 ARRAY['baked_goods', 'processed_meats', 'chocolate', 'salad_dressing'], 3),

('nuts',
 ARRAY['almonds', 'walnuts', 'cashews', 'pistachios', 'hazelnuts', 'pecans', 'brazil_nuts'],
 ARRAY['baked_goods', 'cereals', 'energy_bars', 'sauces'], 3),

('peanuts',
 ARRAY['peanuts', 'peanut_butter', 'peanut_oil'],
 ARRAY['asian_cuisine', 'baked_goods', 'cereals', 'candy'], 3),

('shellfish',
 ARRAY['shrimp', 'crab', 'lobster', 'clams', 'mussels', 'oysters'],
 ARRAY['fish_sauce', 'worcestershire_sauce', 'caesar_dressing'], 3),

('fish',
 ARRAY['salmon', 'tuna', 'cod', 'fish_oil'],
 ARRAY['worcestershire_sauce', 'caesar_dressing', 'supplements'], 2),

('eggs',
 ARRAY['eggs', 'egg_whites', 'albumin', 'lecithin'],
 ARRAY['baked_goods', 'pasta', 'mayonnaise', 'ice_cream'], 2),

('soy',
 ARRAY['soybeans', 'soy_sauce', 'tofu', 'tempeh', 'miso'],
 ARRAY['processed_foods', 'vegetarian_meat', 'chocolate', 'bread'], 1),

('gluten',
 ARRAY['wheat', 'barley', 'rye', 'bulgur', 'semolina'],
 ARRAY['soy_sauce', 'beer', 'processed_foods', 'oats'], 2);
...
CREATE TABLE IF NOT EXISTS user_nutrition_analysis (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE,
  ...
  deficient_nutrients TEXT[] DEFAULT '{}', -- Nutrients consistently below RDA
  excess_nutrients TEXT[] DEFAULT '{}', -- Nutrients consistently above UL
